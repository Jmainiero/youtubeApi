...
const interval = setInterval(function () {
    ...
    vtn.forEach(function (el) {
        el.addEventListener("click", function (event) {
            ...
            document.getElementById('video-container').innerHTML = `<iframe width="480" height="270" src="//www.youtube.com/embed/${this.getAttribute('data-video')}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
        });
    });
}, 3000);